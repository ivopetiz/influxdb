...
Generates a source tarball of influxdb that can be extracted to a new `GOPATH` such that you can `go build github.com/ivopetiz/influxdb/cmd/influxd`, etc., without manually setting linker flags or anything.
